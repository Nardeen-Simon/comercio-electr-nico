...
public class SD9_AddToCartStepDefinitions {
    ...
    public void user_choose_books_the_category() throws InterruptedException {
        //create objects
    ...
    public void click_on_book_add_to_cart_button() throws InterruptedException {
        addToCart.AddCItemToCart(Hook.driver).click();
        Thread.sleep(3000);
    }
    @Then("book added to the shopping cart")
    public void product_book_added_to_the_shopping_cart() throws InterruptedException {
    ...
    public void click_on_another_book_add_to_cart_button() throws InterruptedException {
        addToCart.AddCItemToCart2(Hook.driver).click();
        Thread.sleep(3000);
    }
    @Then("another book added to the shopping cart")
    public void another_book_added_to_the_shopping_cart() throws InterruptedException {
        String expectedResult = "The product has been added to your ";
        String actualResult = Hook.driver.findElement(addToCart.AssertResult()).getText();
        Assert.assertTrue(actualResult.contains(expectedResult));
        Thread.sleep(3000);
